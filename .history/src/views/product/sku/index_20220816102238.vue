 ...
 * @LastEditTime: 2022-08-16 10:22:38
  ...
  <div>
    ...
    <el-table style="width:100%" border :data="records">
      ...
      <el-table-column prop="prop" label="操作">
        <template slot-scope="{row,$index}">
          <el-button type="success" icon="el-icon-bottom" size="mini" v-if="row.isSale == 0"></el-button>
          <el-button type="success" icon="el-icon-top" size="mini" v-else></el-button>
