 ...
 * @LastEditTime: 2022-08-16 10:13:02
...
<template>
  <div>
    ...
    <el-pagination @current-change="getSkuList" :total="total" :current-page="page" :page-sizes="[3, 5, 10]"
      :page-size="limit" layout="prev,pager,next,jumper,->,sizes,total" style="text-align:center"></el-pagination>
  </div>
</template>
