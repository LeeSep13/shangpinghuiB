 ...
 * @LastEditTime: 2022-08-15 17:12:42
...
export default {
  ...
  data() {
    return {
      ...
      skuInfo: {
        "category3Id": 0,
        "createTime": "2022-08-15T07:40:44.772Z",
        "id": 0,
        "isSale": 0,
        "price": 0,
        "skuAttrValueList": [
  ...
  methods: {
    ...
    async getData(category1Id, category2Id, spu) {
      ...
      // 获取平台属性的数据
      let AttrInfoResult = await this.$API.sku.reqAttrInfoList(category1Id, category2Id, spu.category3Id);
