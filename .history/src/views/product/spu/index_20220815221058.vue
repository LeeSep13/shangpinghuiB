 ...
 * @LastEditTime: 2022-08-15 22:10:58
  ...
  <div>
    ...
    <el-dialog :title="`${spu.spuName}的sku列表`" :visible.sync="dialogTableVisible">
      ...
      <el-table :data="skuList" style="width:100%" border>
        ...
        <el-table-column prop="prop" label="价格"></el-table-column>
        <el-table-column prop="prop" label="重量"></el-table-column>
        <el-table-column prop="prop" label="默认图片"></el-table-column>
      </el-table>
    </el-dialog>
  </div>
</template>
