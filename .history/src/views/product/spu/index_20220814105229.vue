 ...
 * @LastEditTime: 2022-08-14 10:52:29
        ...
        <el-table style="width:100%" border :data="records">
          ...
          <el-table-column label="操作">
            <template slot-scope="{row,$index}">
              <hint-button type="info" icon="el-icon-info" size="mini"></hint-button>
              <hint-button type="waring" icon="el-icon-edit" size="mini"></hint-button>
              <hint-button type="delete" icon="el-icon-delete" size="mini"></hint-button>
              <hint-button type="success" icon="el-icon-plus" size="mini"></hint-button>
            </template>
          </el-table-column>
        </el-table>
