 ...
 * @LastEditTime: 2022-08-15 09:48:11
...
export default {
  ...
  methods: {
    ...
    handleRemove(file, fileList) {
      // file参数：代表的是删除的那个图片
      // fileList: 照片墙删除某一图片后的剩余的其他图片
      // 收集照片墙图片数据
      // 因为照片墙显示数据务必要有name、url字段，但对服务器而言，不需要。
      // 所以将来需要提交图片数据给服务器的时候整理参数
    ...
    addSaleAttrValue(row) {
      // 点击销售属性值中的添加按钮时，button变为input，需要通过当前销售属性的inputVisible控制
