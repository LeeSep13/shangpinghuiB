 ...
 * @LastEditTime: 2022-08-17 16:54:28
  ...
  <el-card class="box-card" style="margin:10px 0px">
    ...
    <div class="flexbet">
      ...
      <div style="width:25%">
        ...
        <!-- v-if="this.activeName == 'sale'" -->
        <ul>
          <li v-for="store in storeranking.sale">
            <!-- circle -->
            <!-- <span class="rindex">{{ index }}</span> -->
...
export default {
  ...
  data() {
    return {
      ...
      storeranking: {
        sale: {
          name: ['肯德基', '麦当劳', '肯德基', '海底捞', '西北筱面村', '汉堡王', '真功夫'],
          volume: ['323,234', '299,132', '283,998', '266,223', '223,445', '219,663', '200,997']
        },
        visits: {
          name: ['麦当劳', '肯德基', '必胜客', '海底捞', '西北筱面村', '汉堡王', '真功夫'],
          volume: ['211,335', '210,597', '200,998', '199,220', '195,444', '180,161', '172,995']
        }
      }
    }
  },
  ...
  methods: {
    ...
    handleClick() {
      console.log(this.storeranking.sale.name);
    },
    // 本天
    setDay() {
