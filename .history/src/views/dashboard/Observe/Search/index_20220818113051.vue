 ...
 * @LastEditTime: 2022-08-18 11:30:14
...
<template>
  <el-card>
    ...
    <div>
      <el-row :gutter="10">
        <el-col :span="12">
          <lineCharts :data="searchusers" v-if="searchtimes.users.trend.length == 7" />
        </el-col>
        <el-col :span="12">
          <lineCharts :data="searchpercapita" v-if="searchpercapita.percapita.trend.length == 7" />
        </el-col>
      </el-row>
      <!-- table表格 -->
