 ...
 * @LastEditTime: 2022-08-18 16:28:21
...
<template>
  <el-card>
    ...
    <div>
      ...
      <!-- 分页器 -->
      <el-pagination layout="->,prev, pager, next" :total="totals" :current-page="page" :page-size="limit"
...
export default {
  ...
  watch: {
    listState() {
      this.totals = this.listState.search.total
      this.tableData = this.listState.search.searchWord
